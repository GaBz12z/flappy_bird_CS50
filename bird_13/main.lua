...
--[[
    Things done = {
        Added random gaps and intervals to the pipe spawn,
        Added rotation to the bird sprite every time you jump,
        Added a few debug informations (collision box and some numbers),
        Added a simple high score system without persistence,
    }  

    To do =  {
        Award a player with something based on the score,
...
local BACKGROUND_2_SCROLL_SPEED = 30
local BACKGROUND_SCROLL_SPEED = 45
local GROUND_SCROLL_SPEED = 60

-- Dimension in the sprite where the code loops the background, all backgrounds have the same width
...
function love.load()
    ...
    debugFont = love.graphics.newFont('fonts/flappy.ttf', 10)
...
function love.update(dt)
    ...
    backgroundScroll_2 = (backgroundScroll_2 + BACKGROUND_2_SCROLL_SPEED * dt) % BACKGROUND_LOOPING_POINT
